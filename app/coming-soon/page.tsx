    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center relative overflow-hidden">
        ...
        <div className="space-y-8 max-w-2xl">
          <div className="inline-flex items-center gap-2 bg-brand-yellow/20 text-brand-blue px-4 py-2 rounded-full font-bold text-sm">
            <Hammer className="w-4 h-4" />
            Under Construction
          </div>

          <h1 className="text-5xl lg:text-7xl font-black text-brand-blue leading-tight">
            Something Great is <br />
            <span className="text-brand-yellow bg-brand-blue px-4 py-2 inline-block -rotate-1">
              Coming Soon
            </span>
          </h1>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/"
              className="flex items-center gap-2 bg-brand-blue text-white px-8 py-4 rounded-2xl font-black text-lg hover:bg-brand-blue/90 transition-all hover:scale-105 shadow-xl shadow-brand-blue/20"
            >
        ...
        <div className="absolute bottom-12 opacity-5 scale-150 -z-20 border-4 border-brand-blue rounded-full p-20 animate-pulse">
